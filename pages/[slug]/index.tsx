...
useEffect(() => {
  ...
  const totalVenda = imoveis.filter(
    (i) => i.finalidade === "VENDA" && i.status === "DISPONIVEL"
  ).length;
  const totalAluguel = imoveis.filter(
    (i) => i.finalidade === "ALUGUEL" && i.status === "DISPONIVEL"
  ).length;
              ...
              <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-white/70 dark:text-white/60 text-lg leading-relaxed max-w-md">
                    Utilizamos as ferramentas de marketing mais avançadas do setor para garantir que
                    seu imóvel seja visto pelos compradores certos.
                  </p>
                </div>
